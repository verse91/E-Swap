...
const features = [
    "Đổi pin siêu tốc dưới 2 phút",
    "Năng lượng 100% từ mặt trời (Zero-Emission)",
    "Hệ thống quản lý pin thông minh (SOH Tracking)",
    "Tương thích với nhiều dòng xe (Nền tảng Mở)",
    "Thanh toán linh hoạt: Trả theo lần hoặc theo gói thuê bao",
    "Dịch vụ hỗ trợ và điều phối pin bằng AI 24/7",
];
                        ...
                        <DrawerFooter className="flex flex-col gap-2.5 px-0">
                            <div className="w-full">
                                <Link
                                    ...
                                    aria-label={`Purchase ${selectedOption.packName}`}
                                >
                                    <motion.span
                                    ...
                                    >
                                        {primaryButtonText} {selectedOption.packName}
                                        <motion.div
                                            animate={{
                                                rotate: [0, 15, -15, 0],
                                                y: [0, -2, 2, 0],
