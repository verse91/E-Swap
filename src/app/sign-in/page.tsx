          ...
          <div className="space-y-3">
            <Link href="/" className="inline-flex items-center gap-3 group">
              <div className="relative">
                ...
                <div className="relative w-12 h-12 bg-gradient-to-br from-emerald-500 to-green-600 dark:from-emerald-400 dark:to-green-500 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-105 transition-transform">
          ...
          <div className="space-y-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Button
                type="submit"
                size="lg"
                className="w-full h-12 text-base bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white shadow-lg shadow-green-600/25 hover:shadow-xl hover:shadow-green-600/30 transition-all"
                disabled={loading}
              >
                {loading ? (
                  ...
                  <>
                    {mode === "sign-in" ? "Đăng nhập ngay" : "Tạo tài khoản E-Swap"}
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="w-full h-12 text-base border-2 hover:bg-accent transition-all"
